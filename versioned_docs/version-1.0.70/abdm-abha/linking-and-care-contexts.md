...
:::note
Per-patient linking only runs when **care-context linking** is enabled for the tenant — this is a tenant-level setting configured alongside the main ABDM enablement. See *Configuration*.
:::
