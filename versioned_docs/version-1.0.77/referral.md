...
![Pending Referrals List](https://m16-cloudinary-imported-assets.s3.ap-south-1.amazonaws.com/Screenshot_from_2022-01-14_23-29-17_huwaqz.png)

## Add New Referral Patient

![Add Referral Patient](https://m16-cloudinary-imported-assets.s3.ap-south-1.amazonaws.com/Screenshot_from_2022-01-15_00-01-31_ascubr.png)
...
![Add new referral patient](https://m16-cloudinary-imported-assets.s3.ap-south-1.amazonaws.com/Screenshot_from_2022-01-14_23-58-14_vhklxx.png)
...
![Completed Referrals List](https://m16-cloudinary-imported-assets.s3.ap-south-1.amazonaws.com/Screenshot_from_2022-01-15_00-50-57_iakk9w.png)

## Referral Doctors

This section contains list of referral doctors that are registered on the platform.

![Referral Doctors List](https://m16-cloudinary-imported-assets.s3.ap-south-1.amazonaws.com/Screenshot_from_2022-01-15_00-29-02_e8gpje.png)
...
![Add new referral-doctor](https://m16-cloudinary-imported-assets.s3.ap-south-1.amazonaws.com/Screenshot_from_2022-01-15_00-31-38_ovwbim.png)
...
![Referral Doctors List](https://m16-cloudinary-imported-assets.s3.ap-south-1.amazonaws.com/Screenshot_from_2022-01-15_00-35-54_rjnipl.png)
...
![Approve Doctors list](https://m16-cloudinary-imported-assets.s3.ap-south-1.amazonaws.com/Screenshot_from_2022-01-15_00-44-04_fvdsrz.png)

## Recording who sent the patient

When creating a navigation or editing a bill, you record where the patient came
from using a **Source / Referral** selector:

- **Source** — a non-clinical origin, such as a camp or a campaign.
- **Referral** — a referring doctor.

The **Referral** option only appears for users who are allowed to create referral
doctors. Anyone else sees **Source** alone, and an attempt to add a referral
doctor without that permission is refused with a message rather than failing
silently.

## Referral doctor form limits

- **Profile photo** — up to **5 MB**. A larger file is rejected on selection with
  a message, before any upload is attempted.
- **Mobile number** — validated against the mobile-number length your site uses,
  so a mistyped number is caught at entry.
