...
![Pending Referrals List](/img/ReferalPending.png)

## Add New Referral Patient

![Add Referral Patient](/img/RefAdd.png)
...
![Add new referral patient](/img/PatientRef.png)
<!-- 
## Scheduled Referrals
...
![Completed Referrals List](/img/RefComp.png)

## Cancelled Referrals
In Cancelled Referrals List, all referral patients who cancelled the refferals  are shown.

![Cancelled Referrals List](/img/RefCancel.png)
...
![Referral Doctors List](/img/RefDocs.png)
...
![Add new referral-doctor](/img/AddRefDoc.png)
...
![Referral Doctors List](/img/RefDocRegister.png)
...
![Approve Doctors list](/img/RefDocApprove.png)
