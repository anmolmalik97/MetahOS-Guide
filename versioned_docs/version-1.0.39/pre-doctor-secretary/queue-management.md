...
![Queue Management Screen](/img/qms.png)

## Token Number

**Token number** of patients is shown in **Blue Block** with the patient name.

![Token number with the name](/img/token.png)
...
<video controls width="100%">
  <source src="/videos/queue1.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>

The current status will also be reflected in the `OPD Worklist`.

![Current status is reflected in OPD Worklist](/img/opd_que.png)
