...
<video controls width="100%">
  <source src="/videos/ConsultationScreen.mp4" type="video/mp4" />
...
![Top Section](/img/HeaderWidget.png)
...
<video controls width="100%">
  <source src="/videos/Symptoms.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
...
-->
<video controls width="100%">
  <source src="/videos/WorkingDiagnosis.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
## Action Buttons for Consultants/Clinicians

![Doctor Action Buttons](/img/ClinicianActionButtons.png)
...
![Completing the Consultation](/img/Consultbuttons.png)
...
![Completing Consultation Action Buttons](/img/ConsultActionButtons.png)

### Cross Consultation Button

![Cross Consult the  Patient](/img/CrossConsultButton.png)

When you click the XC button, it will bring up the screen to enter the new refferal doctor of any department in the same hospital or branch.

![Cross Consultation from OP](/img/CrossConsultation.png)
