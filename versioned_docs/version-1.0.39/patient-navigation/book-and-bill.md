...
![Create Navigation](/img/CreateNavigationButton.png)

You will be taken to the **Patient Billing Screen**

![Patient Billing Screen](/img/PatientBillingScreen.png)

On the top you will notice Book Surgery Appointment,Book Appointment,Show Old Bills,Patient Wallet,Print Estimation,Consents, Patient Permissions, these can be activated by clicking on them.

![Advance, Estimates and Consents](/img/Consents.png)
...
<video controls width="100%">
  <source src="/videos/Book&BillService.mp4" type="video/mp4" />
...
<video controls width="100%">
  <source src="/videos/EnterServiceLineItems.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
...
<video controls width="100%">
  <source src="/videos/BillGeneration.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>

### To Create Patient Wallet and How it is used as Hospital Wallet In Booking Services
 
<video controls width="100%">
  <source src="/videos/AdvancePaymentRecord.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>